...
from backbone.ResNet18_our import resnet18_our
import torch.nn.functional as F
from datasets.seq_tinyimagenet import base_path
from PIL import Image
from datasets.utils.validation import get_train_val
from datasets.utils.continual_dataset import ContinualDataset, store_masked_loaders
from datasets.utils.continual_dataset import get_previous_train_loader, get_previous_gan_loader
...
class SequentialCIFAR10(ContinualDataset):
    ...
    def not_aug_dataloader_no_transform(self, batch_size):
    ...
    @staticmethod
    def get_backbone_our():
        output_dim = 20 * SequentialCIFAR10.N_CLASSES_PER_TASK * SequentialCIFAR10.N_TASKS
        return resnet18_our(output_dim)
