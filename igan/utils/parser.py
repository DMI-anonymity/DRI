...
def get_dagan_args():
    parser = argparse.ArgumentParser(
        description="Use this script to train a Igan.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser.add_argument(
        "dataset_path",
        type=str,
        help="Filepath for dataset on which to train Igan. File should be .npy format with shape "
        "(num_classes, samples_per_class, height, width, channels).",
    )
    parser.add_argument(
        "final_model_path", type=str, help="Filepath to save final Igan model."
    )
    parser.add_argument(
        "--batch_size",
        nargs="?",
...
def get_omniglot_classifier_args():
    ...
    parser.add_argument(
        "generator_path",
        type=str,
        help="Filepath for Igan generator to use for augmentations.",
    )
    parser.add_argument(
        "--dataset_path",
        type=str,
    ...
    parser.add_argument(
        ...
        "Useful to isolate data that wasn't used during Igan training.",
    )
    parser.add_argument(
        "--num_training_classes",
        nargs="?",
